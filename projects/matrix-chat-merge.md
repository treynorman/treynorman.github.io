...
**Includes:  [Matrix](https://matrix.org/) [Synapse](https://github.com/element-hq/synapse) (server), [PostgreSQL](https://www.postgresql.org/) (database), [Matrix chat bridges](https://matrix.org/ecosystem/bridges/), [Element](https://app.element.io/) (web / mobile client), [ntfy](https://ntfy.sh/) (notification service)**  
...
services:
  ntfy:
    ...
    volumes:
      - /your-data-dir/ntfy:/var/lib/ntfy
    ports:
      - 8093:80
    command: serve
```

Replace `http://ntfy.example.com` with a subdomain of your choice. Replace `/your-data-dir/ntfy` with the location you chose for your ntfy data. The rest of the settings/environment variables can remain unchanged, but feel free to customize. [Ntfy configuration documentation](https://docs.ntfy.sh/config/).
